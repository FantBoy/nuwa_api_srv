"""
Django settings for nuwa_api_srv project.
...
SECRET_KEY = '+l%o--#s5)4!7hobd-x#o5s1p4&&zid0f&w7s)kl17t9+yi3)2'
...
ROOT_URLCONF = 'nuwa_api_srv.urls'
...
WSGI_APPLICATION = 'nuwa_api_srv.wsgi.application'

DATABASE_ROUTERS = ['models.router.DatabaseRouter']
